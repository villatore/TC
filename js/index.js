    ...
    $(document).on("pageinit", "#home", function () {
        ...
        var cantVentas = 0;
            if (JSON.parse(localStorage.getItem("ToruzCart")) != null && JSON.parse(localStorage.getItem("ToruzCart")) != undefined)
                if (JSON.parse(localStorage.getItem("ToruzCart"))[0] != undefined)
                    if (localStorage.getItem(JSON.parse(JSON.parse(localStorage.getItem("ToruzCart"))[0]).Nombre) != undefined)
                        if (localStorage.getItem(JSON.parse(JSON.parse(localStorage.getItem("ToruzCart"))[0]).Nombre)!= null)
